...
๏𝚅𝙸𝚂𝙸 @Rythm_support 𝙵𝙾𝚁 𝙼𝙾𝚁𝙴...
๏───────────────────────๏

⏤͟͟͞͞•𓊈𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 @D3AD_B0Y 𓊉
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="🌱ꜱᴏᴜʀᴄᴇ🌱",
      url=f"https://t.me/ishqsufiiyana",
        ),
    ],
]
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ",
                            callback_data="https://github.com/Vikku1343/RythmManageBot",
                        ),
                    ],
                    [
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1808943146 and DONATION_LINK:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {BOT_NAME} sᴏʀᴄᴇ ᴄᴏᴅᴇ ɪs [ᴀɴᴏɴʏᴍᴏᴜs](https://t.me/RythmmSupport)."
